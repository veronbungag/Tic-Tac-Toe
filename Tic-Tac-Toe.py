...
symbol_thickness = 30
symbol_X_color = '#850e35'
symbol_O_color = '#ee6983'
Pink_color = '#C41E3A'
bg_color = '#fff5e4'  
...
class Tic_Tac_Toe():
    ...
    def __init__(self):
        ...
        self.canvas = Canvas(self.window, width=size_of_board, height=size_of_board, bg=bg_color)  # Set background color
        self.canvas.pack()
    ...
    def display_gameover(self):
        ...
        self.score_frame = Frame(self.window, bg=Pink_color)
        self.score_frame.place(relx=0.5, rely=0.3, anchor="n")
        Label(self.score_frame, text="Scores", font="Arial", bg=Pink_color, fg="white").grid(row=0, columnspan=2, pady=(0, 10))
        Label(self.score_frame, text="Player", font="cmr 25 bold", bg=Pink_color, fg="white", width=15, anchor="w").grid(row=1, column=0, padx=5)
        Label(self.score_frame, text="Score", font="cmr 25 bold", bg=Pink_color, fg="white", width=5).grid(row=1, column=1, padx=5)
        Label(self.score_frame, text="Player 1 (X)", font="cmr 20", bg=Pink_color, fg="white", anchor="w", width=15).grid(row=2, column=0, padx=5, pady=5)
        Label(self.score_frame, text=str(self.X_score), font="cmr 20", bg=Pink_color, fg="white", width=5).grid(row=2, column=1, padx=5, pady=5)
        Label(self.score_frame, text="Player 2 (O)", font="cmr 20", bg=Pink_color, fg="white", anchor="w", width=15).grid(row=3, column=0, padx=5, pady=5)
        Label(self.score_frame, text=str(self.O_score), font="cmr 20", bg=Pink_color, fg="white", width=5).grid(row=3, column=1, padx=5, pady=5)
        Label(self.score_frame, text="Tie", font="cmr 20", bg=Pink_color, fg="white", anchor="w", width=15).grid(row=4, column=0, padx=5, pady=5)
        Label(self.score_frame, text=str(self.tie_score), font="cmr 20", bg=Pink_color, fg="white", width=5).grid(row=4, column=1, padx=5, pady=5)
